...
abstract class RakLib{
        ...
        /* Syrim: SEND_QUEUE no se implementa en RakLib v113 - el envío de paquetes
         * encolados se hace internamente via Session->addEncapsulatedToQueue().
         * PACKET_SEND_QUEUE se reserva para futuras versiones del protocolo RakLib.
         *
         * SEND_QUEUE payload:
         * byte (identifier length)
         * byte[] (identifier)
