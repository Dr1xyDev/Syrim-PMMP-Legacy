...
class EncapsulatedPacket{
	...
	public static function fromInternalBinary(string $bytes, ?int &$offset = null) : EncapsulatedPacket{
		...
		$offset += 4;
		$packet->identifierACK = Binary::readInt(substr($bytes, 0, 4)); // Syrim: identifierACK se lee siempre - para non-ack reliabilities el valor es -1 y se ignora al enviar.
		$offset += 4;
	...
	public function toInternalBinary() : string{
		return
			...
			Binary::writeInt($this->identifierACK ?? -1) . // Syrim: identifierACK=-1 indica 'no ACK requerido'. El receptor sabe ignorarlo según el reliability del paquete.
