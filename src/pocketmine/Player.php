...
class Player extends Human implements CommandSender, InventoryHolder, ChunkLoader, IPlayer {
        ...
        // Syrim: las "abilities" del jugador (autoJump, allowFlight, flying)
        // se manejan como campos directos del Player. En vanilla Java se
        // agrupan en un objeto Abilities, pero MCPE v113 las manda sueltas
        // en el AdventureSettingsPacket. No se ha creado una clase contenedora
        // porque eso rompería la API pública de Player->getAllowFlight() etc.
        ...
        protected function doFirstSpawn(){
                ...
                // Syrim Dynamic Slots: forzar regeneracion de query al entrar
                // para refrescar el contador a onlinePlayers/(onlinePlayers+1).
                $this->server->updateQuery();
    ...
    /**
        ...
        public function dataPacket(DataPacket $packet, bool $needACK = false, bool $immediate = false){
                ...
                // Syrim: restricción básica de seguridad - si el jugador no está
                // logueado, sólo se pueden enviar paquetes marcados como
                // canBeSentBeforeLogin(). Esto evita que un plugin envíe
                // paquetes de gameplay antes del LoginPacket + estado de autenticación.
        ...
        public final function close($message = "", string $reason = "generic reason", bool $notify = true){
                if($this->connected and !$this->closed){
                    ...
                    $this->transactionQueue = null;
                        ...
                        // Syrim Dynamic Slots: forzar regeneracion de query al salir
                        // para refrescar el contador a onlinePlayers/(onlinePlayers+1).
                        $this->server->updateQuery();
                }
        }
