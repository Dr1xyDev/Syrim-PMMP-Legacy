<?php
/*
 * Syrim - Port de Nukkit 1.1.5 DarkOakTreePopulator
 * Usa el ObjectDarkOakTree ya porteado (en pocketmine\level\generator\object)
 */
...
class DarkOakTreePopulator extends Populator {
