                ...
                if(isset($args[$offset])){
                        ...
                        switch($args[$offset]){
                                case "@a":
                                        ...
                                        if(count($p) <= 0){
                                                $sender->sendMessage(TextFormat::RED . $this->server->getLanguage()->translateString("commands.noPlayersOnline"));
                                        }else{
                                                foreach($p as $player){
                                ...
                                case "@p":
                                        if($sender instanceof Player){
                                                ...
                                                $sender->sendMessage(TextFormat::RED . $this->server->getLanguage()->translateString("commands.mustBePlayer"));
                                        }
                                        break;
                                default:
                                        $this->dispatchAdvanced($sender, $command, $label, $argsTemp, $offset + 1);
