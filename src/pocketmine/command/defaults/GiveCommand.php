        ...
        public function execute(CommandSender $sender, $currentAlias, array $args){
                ...
                try{
                        ...
                        if($player instanceof Player){
                                ...
                                // Syrim: addItem() ya devuelve un array con los items que no
                                // cupieron en el inventario. Si queda algo fuera, lo dejamos
                                // caer al suelo para no perderlo silenciosamente.
                                $remaining = $player->getInventory()->addItem(clone $item);
                                foreach($remaining as $drop){
                                        $player->getLevel()->dropItem($player->add(0, 1, 0), $drop);
                                }
                        }else{
