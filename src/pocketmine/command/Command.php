...
abstract class Command{
        ...
        public function generateCustomCommandData(Player $player){
                // Syrim: el filtrado de permisos por overload sigue comentado porque
                // en MCPE v113 el cliente NO filtra correctamente los overloads cuando
                // se marca el commandData como permission-restricted, y esto provocaba
                // que comandos válidos no aparecieran en el autocompletador del chat.
                // La verificación real de permisos se hace server-side en testPermission().
