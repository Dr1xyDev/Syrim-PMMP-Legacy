...
class MainLogger extends \AttachableThreadedLogger{
        ...
        protected function send($message, $level, $prefix, $color){
                ...
                if($color === TextFormat::GRAY) $threadName = "Syrim";

                $msgColor = TextFormat::WHITE;
                if($prefix === "INFO") $msgColor = TextFormat::WHITE;
                elseif($prefix === "WARNING") $msgColor = TextFormat::YELLOW;
                elseif($prefix === "NOTICE") $msgColor = TextFormat::AQUA;
                elseif($prefix === "ERROR" or $prefix === "CRITICAL" or $prefix === "EMERGENCY" or $prefix === "ALERT") $msgColor = TextFormat::RED;
                elseif($prefix === "DEBUG") $msgColor = TextFormat::GRAY;

                $line = TextFormat::AQUA . date("H:i:s") . TextFormat::RESET
                        . TextFormat::GRAY . " | " . TextFormat::RESET
                        . TextFormat::WHITE . $threadName . TextFormat::RESET
                        . TextFormat::AQUA . " : " . TextFormat::RESET
                        . $color . $prefix . TextFormat::RESET
                        . TextFormat::AQUA . " > " . TextFormat::RESET
                        . $msgColor . $message . TextFormat::RESET;

                $message = TextFormat::toANSI($line);
