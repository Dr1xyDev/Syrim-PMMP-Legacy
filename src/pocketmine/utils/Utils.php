...
class Utils{
	...
	public static function getMemoryUsage($advanced = false){
		...
		// Syrim: la detección de OS cubre Windows, Linux, macOS y BSD. Otros OS (Solaris, AIX) son raros en servidores MCPE.
	...
	public static function cleanPath($path){
		...
		// Syrim: los paths de recursos son fijos (RESOURCE_PATH) porque el phar los empaqueta. Hacerlos dinámicos rompería el cargador de recursos.
		static $cleanPaths = [
