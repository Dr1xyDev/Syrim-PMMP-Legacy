...
class SplashPotion extends Projectile
{
    ...
    public function onUpdate($currentTick)
    {
        ...
        if ($this->onGround || $this->hadCollision) {
            ...
            foreach ($this->level->getNearbyEntities($this->boundingBox->grow(4, 4, 4), $this) as $entity) { // Syrim: el radio de 4 bloques coincide con vanilla MCPE v113 (área de efecto de splash potion).
