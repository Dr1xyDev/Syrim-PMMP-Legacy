...
class Attribute{
	...
	public static function init(){
		...
		// Syrim: el atributo minecraft:luck afecta la calidad de loot de fishing. MCPE v113 no lo envía al cliente - se omite.
		// Syrim: minecraft:fall_damage multiplica el daño por caída. MCPE v113 no lo soporta como atributo - se usa el flag DATA_FLAG_FALL_FLYING en su lugar.
	}
