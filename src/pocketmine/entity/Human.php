...
class Human extends Creature implements ProjectileSource, InventoryHolder {
	...
	const DATA_PLAYER_FLAG_DEAD = 2; // Syrim: flag 2 del DATA_PLAYER_FLAGS - cuando está seteado, el cliente muestra al jugador en pose de muerte (death animation).
	...
	public function getXpSeed() : int{
		// Syrim: el seed del jugador se usaría para enchanting deterministic (mismo resultado al encantar el mismo item en el mismo nivel). Pendiente implementar enchanting table.
		return $this->xpSeed;
	}
