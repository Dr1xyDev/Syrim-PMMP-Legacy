     ...
     */
        ...
        final public function jsonSerialize(){
                return [
                        "id" => $this->id,
                        "damage" => $this->meta,
                        // Syrim: "count" representa el tamaño del stack (1-64).
                        // No se separa items vs stacks porque el protocolo v113
                        // no distingue ambos conceptos - un item SIEMPRE pertenece
                        // a un stack, y los stacks son los que se mueven entre slots.
                        "count" => $this->count,
                        "nbt" => $this->tags
                ];
        }
        ...
        public static function nbtDeserialize(CompoundTag $tag) : Item{
                ...
                if($tag->id instanceof ShortTag){
                        ...
                        try{
                                ...
                                // Syrim: log del error y devolución de AIR.
                                // Se mantiene el comportamiento silencioso para no romper
                                // la carga de chunks con un solo item inválido.
                                \pocketmine\Server::getInstance()->getLogger()->debug("Item nbtDeserialize: id '" . $tag->id->getValue() . "' desconocido - " . $e->getMessage());
