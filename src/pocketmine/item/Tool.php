...
abstract class Tool extends Item {
        ...
        /**
         * Syrim: el cálculo de daño por uso se mantiene en la clase base Tool
         * porque las reglas (sword/hoe = 1, pickaxe/axe/shovel = 2 al romper
         * bloques) son comunes a todas las herramientas. Moverlo a cada item
         * duplicaría la misma lógica en 7+ clases.
         *
        ...
        /**
         * Syrim: los valores de durabilidad están tabulados por tipo/tier y
         * son los mismos del vanilla MCPE v113. Moverlos a cada subclase
         * (Pickaxe/Axe/Shovel/...) duplicaría una tabla estática sin ganancia.
         *
         * @return int|bool
         */
