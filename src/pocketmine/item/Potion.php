...
class Potion extends Item {
        ...
        const WEAKNESS = 34;
        const WEAKNESS_T = 35;
        // Syrim: pocion DECAY (ID 36) aplica el efecto WITHER al objetivo.
        // Es la "Potion of Decay" del MCPE 1.1 (sólo obtenible via /give).
        const DECAY = 36;
        ...
        const POTIONS = [
                ...
                // Syrim: pocion de Decay = efecto WITHER, amplifier 1, 30s.
                self::DECAY => [Effect::WITHER, (30 * 20), 1]
        ];
