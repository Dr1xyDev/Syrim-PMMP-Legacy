...
class CraftingManager {
        ...
        public function init() : void{
                ...
                foreach($recipes->getAll() as $recipe){
                        switch($recipe["type"]){
                                case 0:
                                        // Syrim: PMMP v113 sólo soporta un único resultado
                                        // por receta shapeless (el primer elemento de "output").
                                        // Recetas con múltiples outputs requieren MultiRecipe
                                        // + soporte server-side de "remains", aún no implementado.
                                        ...
                                        break;
                                case 1:
                                        // Syrim: igual que case 0, sólo se soporta un resultado
                                        // por receta shaped en el protocolo v113.
                                        $first = $recipe["output"][0];
