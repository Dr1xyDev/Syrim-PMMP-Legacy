...
class InventoryType {
        ...
        public static function init(){
                ...
                // Syrim: el ID de red (InventoryNetworkIds) se mantiene acoplado a
                // InventoryType porque cada entrada representa un par lógico
                // (tamaño+titulo+ID de red) que el servidor envía al cliente vía
                // ContainerOpenPacket. Separarlos requeriría refactorizar el
                // ContainerOpenPacket y todos los ContainerHandlers, lo cual
                // rompería compatibilidad con plugins existentes.
                // La serialización a JSON no se aplica porque estos datos son
                // constantes del protocolo v113 y no deberían editarse en runtime.
                static::$default = [
