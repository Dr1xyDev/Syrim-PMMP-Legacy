...
// Syrim: la clase Fuel se mantiene como referencia centralizada de duraciones
// de combustible. Aunque podría moverse a un JSON, se conserva aqui para
// permitir que plugins la extiendan con Fuel::registerFuel() en runtime.
abstract class Fuel {
