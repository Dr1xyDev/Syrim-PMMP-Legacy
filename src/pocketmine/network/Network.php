        ...
        public function processBatch(BatchPacket $packet, Player $player){
                ...
                while(!$stream->feof()){
                        ...
                        if(($pk = $this->getPacket(ord($buf[0]))) !== null){
                            ...
                            // Syrim: simple filtro anti-flood: si un mismo tipo de
                            // paquete aparece más de 300 veces en un solo batch,
                            // marcamos la sesión como filtrada para evitar abusos.
                            if(@$packetsCounter[$pk::NETWORK_ID] > 300){
                                    $isFiltered = true;
                                }
