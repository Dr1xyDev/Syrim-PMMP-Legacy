...
class BossEventPacket extends DataPacket {
        ...
        const TYPE_TITLE = 5;
        /* S2C: Syrim: TYPE_UNKNOWN_6 actualiza el color y overlay de la boss-bar.
         * El unknownShort parece ser reservado/unused en v113 - el cliente lo
         * lee pero no lo usa. Los campos color (0-5) y overlay (bitmask) sí
         * afectan visualmente la barra del boss. */
