...
class CraftingDataPacket extends DataPacket {
        ...
        // Syrim: ENTRY_MULTI y ENTRY_SHULKER_BOX ya están soportados
        // en el protocolo v113. ENTRY_MULTI corresponde a MultiRecipe
        // y ENTRY_SHULKER_BOX se trata como shapeless en MCPE 1.1.
        const ENTRY_MULTI = 4;
        ...
        private static function writeEntry($entry, BinaryStream $stream){
                if($entry instanceof ShapelessRecipe){
                        ...
                        // Syrim: serialización de MultiRecipe según el protocolo v113.
                        // El cuerpo sólo contiene el UUID de la receta.
                        return self::writeMultiRecipe($entry, $stream);
                }
        ...
        /**
         * Syrim: serializa un MultiRecipe al protocolo v113.
         *
         * @param MultiRecipe  $recipe
         * @param BinaryStream $stream
         *
         * @return int
         */
        private static function writeMultiRecipe(MultiRecipe $recipe, BinaryStream $stream) : int{
                $stream->putUUID($recipe->getId());

                return CraftingDataPacket::ENTRY_MULTI;
        }
