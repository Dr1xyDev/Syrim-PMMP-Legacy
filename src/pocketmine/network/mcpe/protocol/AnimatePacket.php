...
class AnimatePacket extends DataPacket {
        ...
        public $action;
        public $eid;
        // Syrim: campo "float" del paquete Animate.
        // En el protocolo v113 este float sólo se envía cuando el bit 0x80
        // del action está activo. Se usa para pasar el "rowing time" del boat
        // (ACTION_ROW_RIGHT = 128 / ACTION_ROW_LEFT = 129).
        public $float = 0.0;
