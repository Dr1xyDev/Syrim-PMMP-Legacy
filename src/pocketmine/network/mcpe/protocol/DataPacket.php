                ...
                for($i = 0; $i < $count && !$this->feof(); ++$i){
                        ...
                        switch($type){
                                ...
                                case Entity::DATA_TYPE_SLOT:
                                        // Syrim: se mantiene como array [id, count, damage] para preservar
                                        // compatibilidad con plugins existentes. Una migración a objetos
                                        // Item requeriría romper la API pública de metadata de entidad.
                                        $value = [];
                                        $item = $this->getSlot();
                                        $value[0] = $item->getId();
                ...
                foreach($metadata as $key => $d){
                        ...
                        switch($d[0]){
                                ...
                                case Entity::DATA_TYPE_STRING:
                                        ...
                                        break;
                                case Entity::DATA_TYPE_SLOT:
                                        // Syrim: serialización SLOT desde array [id, count, damage].
                                        $this->putSlot(Item::get($d[1][0], $d[1][2], $d[1][1])); //ID, damage, count
                                        break;
                                case Entity::DATA_TYPE_POS:
                                        // Syrim: serialización POS desde array [x, y, z].
                                ...
                                case Entity::DATA_TYPE_LONG:
                                        ...
                                        break;
                                case Entity::DATA_TYPE_VECTOR3F:
                                        // Syrim: serialización VECTOR3F desde array [x, y, z].
