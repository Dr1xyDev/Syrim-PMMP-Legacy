...
class MovePlayerPacket extends DataPacket {
    ...
    const MODE_PITCH = 3; //facepalm Mojang
        ...
        // Syrim: onGround indica si el jugador está pisando el suelo.
        // El cliente lo envía y el servidor lo replica en paquetes de teleport.
    ...
    public $teleportItem = 0;
        ...
        public function encode(){
                ...
                $this->putLFloat($this->bodyYaw); // Syrim: body/yaw separado del yaw de cabeza
