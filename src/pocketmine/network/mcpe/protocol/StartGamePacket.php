...
class StartGamePacket extends DataPacket {
        ...
        public function encode(){
                ...
                // Syrim: lista vacía de game rules del nivel.
                // En el protocolo v113, el campo es un array (count + entries).
                // Escribimos count = 0 porque Syrim no envía game rules al cliente
                // en este paquete (las game rules se manejan via GameRulesChangedPacket).
