...
class ClientboundMapItemDataPacket extends DataPacket {
        ...
        public function encode(){
                ...
                if(($type & self::BITFLAG_ENTITY_UPDATE) !== 0){
                        // Syrim: BITFLAG_ENTITY_UPDATE contiene la lista de entidades
                        // (jugadores u otros) que están "mirando" el mapa en este momento.
                        // El cliente lo usa para actualizar los iconos de jugadores en mapas
                        // de localización (locator maps) según el protocolo v113.
