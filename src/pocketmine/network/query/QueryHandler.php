...
class QueryHandler {
        ...
        private function debug(string $message) : void{
                // Syrim: se mantiene el prefijo [Query] inline; no se ha añadido
                // un logger dedicado porque crear un PrefixedLogger requeriría
                // cambios en la jerarquía de MainLogger que romperían plugins.
