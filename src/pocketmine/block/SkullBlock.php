...
class SkullBlock extends Flowable {
        ...
        protected function recalculateBoundingBox(){
                // Syrim: en MCPE v113, los skulls siempre usan el mismo bounding
                // box (0.25..0.75 en X/Z, 0..0.5 en Y) sin importar la cara de
                // attached. En vanilla Java el skull-floor tiene Y=0..0.5 y los
                // wall-skulls tienen un bounding box más pequeño, pero el cliente
                // v113 no diferencia - todos renderizan igual. Se mantiene simple.
