...
class Cake extends Transparent implements FoodSource {
        ...
        public function onActivate(Item $item, Player $player = null){
                // Syrim: el handling de comida está acoplado a Cake porque Cake es
                // el único bloque "comible" del vanilla (otros alimentos son Items).
                // Un sistema genérico requeriría una interfaz EdibleBlock con
                // getFoodRestore/getSaturationRestore/getAdditionalEffects,
                // pero no hay otros candidatos en MCPE v113.
