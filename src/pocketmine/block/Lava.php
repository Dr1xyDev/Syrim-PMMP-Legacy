...
class Lava extends Liquid {
        ...
        public function getFlowDecayPerBlock() : int{
                // Syrim: en el Overworld la lava fluye más lenta (decay 2 por bloque),
                // en el Nether fluye más rápido (decay 1 por bloque). La detección
                // de dimensión se hace via Level->getDimension(); Nether = 1.
                $dimension = $this->getLevel()->getDimension();
                return ($dimension === Level::DIMENSION_NETHER) ? 1 : 2;
        }
