...
class PoweredRepeater extends RedstoneSource {
        ...
        public function deactivateImmediately(){
                ...
                // Syrim: el bloque 2 posiciones abajo se desactiva para soportar
                // comparators/repeaters que alimentan bloques a través de un
                // bloque sólido (output through solid block).
