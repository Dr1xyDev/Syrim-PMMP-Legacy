...
abstract class Liquid extends Transparent{
        ...
        protected function liquidCollide(Block $cause, Block $result) : bool{
                // Syrim: disparar BlockFormEvent permite a los plugins cancelar
                // la solidificación (lava + agua = obsidiana/cobble/piedra).
        ...
        protected function canFlowInto(Block $block) : bool{
                // Syrim: el flujo se permite en cualquier bloque "flowable" (air,
                // plants, etc). La restricción de "no fluir sobre líquidos de
                // mismo tipo y meta 0 (source)" evita que el agua/lava reemplace
                // su propia fuente al expandirse lateralmente.
