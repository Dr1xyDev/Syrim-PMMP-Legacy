...
class ItemFrame extends Flowable {
        ...
        public function onBreak(Item $item){
                if(($tile = $this->level->getTile($this)) instanceof TileItemFrame){
                        // Syrim: el drop del item dentro del frame ya se maneja con
                        // dropChance. Un BlockBreakEvent separado para el contenido
                        // sería redundante - el evento padre de onBreak() ya cubre
                        // el caso del bloque ItemFrame en sí.
